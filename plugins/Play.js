// commands/play.js — YouTube Play (Lil Peep Aesthetic Edit)
"use strict";
...
module.exports = async (msg, { conn, text }) => {
  ...
  if (!query) return conn.sendMessage(msg.key.remoteJid, { text: `┼ escribe algo para buscar .\n| uso : .play <tema> [calidad]` }, { quoted: msg });
